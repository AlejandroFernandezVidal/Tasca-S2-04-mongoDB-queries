...
db.restaurantes.find({$and:[{cuisine:{$ne:"American "}},{"grades.score":{$gt:70}},{"address.coord":{$lt:-65.754168}}]});
...
db.restaurantes.find({$nor:[{borough:"American "},{borough:"Chinese"},{name:/^Wil/}]},{"restaurant_id":1,"name":1,"borough":1,"cuisine":1});
22.-Escriu una consulta per probar el restaurant_id, name, i grades per a aquells restaurants que aconsegueixin un grau "A" i un score 11 en dades d'estudi ISODate "2014-08-11T00:00:00Z".
db.restaurantes.find({"grades.grade":"A","grades.score":11,"grades.date":ISODate('2014-08-11T00:00:00Z')},{"restaurant_id":1,"name":1,grades:1});
...
db.restaurantes.find({"address.coord.1":{$gt:42,$lte:52}},{"restaurant_id":1,"name":1,"address":1});
...
db.restaurantes.find({"address.street":""});
db.restaurantes.find({"address.street":null});
...
db.restaurantes.find({},{"address.coord":1});
...
db.restaurantes.find({"name":/mon/},{"name":1,"borough":1,"address.coord":1,"cuisine":1,"_id":0});
...
db.restaurantes.find({"name":/^Mad/},{"name":1,"borough":1,"address.coord":1,"cuisine":1,"_id":0});